...
import { ValidationMessagesComponent } from '../../shared/components/errors.component';
...
@Component({
    selector: 'app-login',
    standalone: true,
    imports: [ReactiveFormsModule, ButtonModule, CheckboxModule, InputTextModule, PasswordModule, FormsModule, RouterModule, RippleModule, AppFloatingConfigurator, ValidationMessagesComponent],
    template: `
                ...
                <div
                    ...
                    <div class="w-full bg-surface-0 dark:bg-surface-900 py-20 px-8 sm:px-20"
                        ...
                        <div class="text-center mb-8">
                            ...
                            <div class="text-surface-900 dark:text-surface-0 text-3xl font-medium mb-4">Test Project
                            </div>
                        ...
                        <form [formGroup]="authForm" (submit)="login()">
                            <div class="mb-6">
                                <label for="email"
                                       class="block text-surface-900 dark:text-surface-0 text-xl font-medium mb-1">Email</label>
                                <input formControlName="email" [disabled]="submitting" pInputText id="email" type="text"
                                       placeholder="Email address" class="w-full md:w-[30rem] mb-4" />
                                <validation-messages [control]="authForm.get('email')" />
                            </div>
                            ...
                            <validation-messages [control]="authForm.get('password')" />
